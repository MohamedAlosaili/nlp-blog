...
import { APIJSONResponse, ErrorCode, PostType, Tag } from "@/types";
  ...
  return (
    <div className="flex items-center gap-4 space-x-2">
      <Switch
        ...
        onCheckedChange={v => onChange({ name: "isPublished", value: v })}
      />
      <label htmlFor="isPublished">
        حالة المقال - {formData.isPublished ? "منشور" : "إلغاء النشر"}
      </label>
    </div>
  );
};
